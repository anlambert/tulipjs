...
void fgHandleExtensionEvents( XEvent* base_ev )
{
    ...
    if ( XGetEventData( fgDisplay.pDisplay.Display, cookie ) && (cookie->type == GenericEvent) && (cookie->extension == xi_opcode) ) {
        ...
        case XI_Leave:
            ...
            fgState.Modifiers = fgPlatformGetModifiers( evcross->mods.effective );
            ...
            std_ev.xcrossing.state = BUTTON_MASK(*(unsigned int*)evcross->buttons.mask) | event->mods.effective;
        ...
        case XI_ButtonRelease:
            fgState.Modifiers = fgPlatformGetModifiers( event->mods.effective );
            ...
            std_ev.xbutton.state = event->mods.effective;
        ...
        case XI_Motion:
            ...
            std_ev.xmotion.state = BUTTON_MASK(*(unsigned int*)event->buttons.mask) | event->mods.effective;
